...
class User{
    ...
    public function insert_viva_data($name, $email, $fb, $skp, $grade, $usremail){
        $query = "INSERT INTO tbl_viva(name, email, facebook, skype, grade, usremail) VALUES('$name', '$email', '$fb', '$skp', '$grade', '$usremail')";
        $insert_row = $this->db->insert($query);
        if($insert_row){
	...
	public function deleteData($id){
        $query = "DELETE FROM tbl_viva WHERE id = '$id'";
        $delData = $this->db->delete($query);
        if(isset($delData)){
    ...
    public function getAllVivaApplier(){
	    ...
	    public function getUserInfomration($usremail){
        $query = "SELECT * FROM tbl_viva where usremail = '$usremail'";
        $result = $this->db->select($query);
        return $result;
    }

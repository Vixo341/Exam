...
<h1> User Registration</h1>
	...
	<form action="" method="post">
        ...
        <br/>
        <p style="font-size: 16px; text-align: center;padding-left: 260px; padding-top: 20px; width:500px; height: 200px;">Already Registered? <a style="text-decoration: none" href="index.php">Login</a> Here</p>
        <br/>
